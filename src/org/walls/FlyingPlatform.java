...
public class FlyingPlatform extends Wall implements Runnable {
	public static final BufferedImage[] ani = new BufferedImage[]{ImagePack.getImage("platforms/Flyplatform1.png"),
			ImagePack.getImage("platforms/Flyplatform2.png"), ImagePack.getImage("platforms/Flyplatform3.png"),
