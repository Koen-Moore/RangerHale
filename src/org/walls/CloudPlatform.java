...
public class CloudPlatform extends Wall {
	private int size;
	private static final BufferedImage[] pics = new BufferedImage[]{ImagePack.getImage("platforms/CloudLeft.png"),
			ImagePack.getImage("platforms/MidCloud.png"), ImagePack.getImage("platforms/CloudRight.png"),
