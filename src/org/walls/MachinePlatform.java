...
public class MachinePlatform extends Wall {
	private int size;
	private final static BufferedImage[] pics = new BufferedImage[]{ImagePack.getImage("platforms/machinePlatformLeft.png"),
			ImagePack.getImage("platforms/machinePlatformMid.png"), ImagePack.getImage("platforms/machinePlatformRight.png"),
