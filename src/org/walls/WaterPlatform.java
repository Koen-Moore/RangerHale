...
public class WaterPlatform extends Wall{
	static final BufferedImage[]pics=new BufferedImage[]{
		ImagePack.getImage("waterlevel/wplatL.png"),
		ImagePack.getImage("waterlevel/wplatM.png"),
		ImagePack.getImage("waterlevel/wplatR.png"),
	};
	int size;
