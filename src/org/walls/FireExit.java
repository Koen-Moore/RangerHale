...
public class FireExit extends Wall implements Runnable {
	public static final BufferedImage[] ani = new BufferedImage[]{ImagePack.getImage("firelevel/fireDoor.png"),
			ImagePack.getImage("firelevel/fireDoor2.png"), ImagePack.getImage("firelevel/fireDoorR.png"),
