...
public class CaveExit extends Wall implements Runnable {
	public static final BufferedImage[] ani = new BufferedImage[]{ImagePack.getImage("earthlevel/caveDoor.png"),
			ImagePack.getImage("earthlevel/caveDoor2.png"), ImagePack.getImage("earthlevel/caveDoorR.png"),
