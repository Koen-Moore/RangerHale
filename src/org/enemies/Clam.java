...
public class Clam extends Enemy {
	private static final BufferedImage[][]ani=new BufferedImage[][]{
		{
			ImagePack.getImage("waterlevel/clam1L.png"),
			ImagePack.getImage("waterlevel/clam2L.png"),
			ImagePack.getImage("waterlevel/clam3L.png"),
			ImagePack.getImage("waterlevel/clam2L.png"),
		},{
			ImagePack.getImage("waterlevel/clam1R.png"),
			ImagePack.getImage("waterlevel/clam2R.png"),
			ImagePack.getImage("waterlevel/clam3R.png"),
			ImagePack.getImage("waterlevel/clam2R.png"),
		}
	};
