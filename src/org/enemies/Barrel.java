...
public class Barrel extends Enemy {
	private static volatile BufferedImage[]ani=new BufferedImage[]{
			...
			ImagePack.getImage("Barrel/Barrel.png"),
			ImagePack.getImage("Barrel/Barrel2.png"),
			ImagePack.getImage("Barrel/Barrel3.png"),
			ImagePack.getImage("Barrel/Barrel4.png"),
			ImagePack.getImage("Barrel/Barrel5.png")
	};
