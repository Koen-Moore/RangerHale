...
public class PurpleFly extends Enemy {
	...
	private static final BufferedImage[] ani = new BufferedImage[]{ImagePack.getImage("PurpleFly1.png"),
			ImagePack.getImage("PurpleFly2.png"), ImagePack.getImage("PurpleFly1r.png"), ImagePack.getImage("PurpleFly2r.png"),};
