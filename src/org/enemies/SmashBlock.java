...
public class SmashBlock extends Enemy{
	static final BufferedImage[]ani=new BufferedImage[]{
		ImagePack.getImage("Robot/smashblock1.png"),
		ImagePack.getImage("Robot/smashblock2.png"),
		ImagePack.getImage("Robot/smashblock3.png"),
		ImagePack.getImage("Robot/smashblock4.png"),
		ImagePack.getImage("Robot/smashblock5.png"),
		ImagePack.getImage("Robot/smashblock6.png"),
		ImagePack.getImage("Robot/smashblockd1.png"),
	...
	public void run(){
		...
		if ((x<p.x+p.w&&x+w>p.x)&&(y<p.y+p.h&&y+h>p.y)){
   			life=0;Player.damage(30);dead=true;
   		}
