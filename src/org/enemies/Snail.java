...
public class Snail extends Enemy {
	public static final BufferedImage[] ani = new BufferedImage[]{ImagePack.getImage("firelevel/firesnail.png"),
			ImagePack.getImage("firelevel/firesnail2.png"), ImagePack.getImage("firelevel/firesnailR.png"),
			ImagePack.getImage("firelevel/firesnail2R.png"), ImagePack.getImage("firelevel/snailshell1.png"),
			ImagePack.getImage("firelevel/snailshell2.png"), ImagePack.getImage("firelevel/snailshell3.png"),
			ImagePack.getImage("firelevel/snailshell4.png"), ImagePack.getImage("firelevel/snailshell5.png"),
			ImagePack.getImage("firelevel/snailshell6.png"), ImagePack.getImage("firelevel/snailshell7.png"),
