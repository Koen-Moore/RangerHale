...
public class Hoopla extends Enemy {
	public static final BufferedImage[] ani = new BufferedImage[]{ImagePack.getImage("earthlevel/hoopla/hoopla.png"),
			ImagePack.getImage("earthlevel/hoopla/hoopla2.png"), ImagePack.getImage("earthlevel/hoopla/hoopla3.png"),
			ImagePack.getImage("earthlevel/hoopla/hoopla4.png"), ImagePack.getImage("earthlevel/hoopla/hoopla5.png"),
			ImagePack.getImage("earthlevel/hoopla/hooplaR.png"), ImagePack.getImage("earthlevel/hoopla/hoopla2R.png"),
			ImagePack.getImage("earthlevel/hoopla/hoopla3R.png"), ImagePack.getImage("earthlevel/hoopla/hoopla4R.png"),
