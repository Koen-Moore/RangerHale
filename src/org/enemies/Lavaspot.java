...
public class Lavaspot extends Enemy{
	private static final BufferedImage[][]ani=new BufferedImage[][]{
		{
			ImagePack.getImage("Lavaspot.png"),
			ImagePack.getImage("Lavaspot2.png"),
			ImagePack.getImage("Lavaspot4.png"),
			ImagePack.getImage("Lavaspot3.png")
		},
		{
			ImagePack.getImage("LavaspotRight.png"),
			ImagePack.getImage("Lavaspot2right.png"),
			ImagePack.getImage("Lavaspot4Right.png"),
