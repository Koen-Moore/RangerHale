...
public class Crab extends Enemy{
	private static final BufferedImage[][]ani=new BufferedImage[][]{
		{
			ImagePack.getImage("crab1L.png"),
			ImagePack.getImage("crab2L.png"),
			ImagePack.getImage("crab4L.png")
		},
		{
			ImagePack.getImage("crab1.png"),
			ImagePack.getImage("crab2.png"),
			ImagePack.getImage("crab4.png")
