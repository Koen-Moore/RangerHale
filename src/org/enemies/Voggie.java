...
public class Voggie extends Enemy {
	public static final BufferedImage[] ani = new BufferedImage[]{ImagePack.getImage("earthlevel/voggies/voggyRun1.png"),
			ImagePack.getImage("earthlevel/voggies/voggyRun2.png"), ImagePack.getImage("earthlevel/voggies/voggySit1.png"),
			ImagePack.getImage("earthlevel/voggies/voggySit2.png"), ImagePack.getImage("earthlevel/voggies/voggyRun1R.png"),
			ImagePack.getImage("earthlevel/voggies/voggyRun2R.png"), ImagePack.getImage("earthlevel/voggies/voggySit1R.png"),
	...
	public void run() {
		...
		/*
		 * boolean onSurface=false; for(Wall wal:Room.walls){
		 * if(Collisions.onTop(this,wal)) onSurface=true; }
		 */
