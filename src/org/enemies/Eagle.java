...
public class Eagle extends Enemy{
	static final BufferedImage[]ani=new BufferedImage[]{
		ImagePack.getImage("earthlevel/rockeagle/eagle1.png"),
		ImagePack.getImage("earthlevel/rockeagle/eagle2.png"),
		ImagePack.getImage("earthlevel/rockeagle/eagleSwoop1.png"),
		ImagePack.getImage("earthlevel/rockeagle/eagleSwoop2.png"),
		ImagePack.getImage("earthlevel/rockeagle/eagle1R.png"),
		ImagePack.getImage("earthlevel/rockeagle/eagle2R.png"),
		ImagePack.getImage("earthlevel/rockeagle/eagleSwoop1R.png"),
	...
	public void run(){
		...
		counter++;
		if(swoopcount>0)swoopcount--;
		if(swoopcount==0&&!swooping)vy=0;
