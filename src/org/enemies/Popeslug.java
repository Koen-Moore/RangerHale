...
public class Popeslug extends Enemy {
	private static volatile BufferedImage[][] ani = new BufferedImage[][]{
			{ImagePack.getImage("Popeslug1.png"), ImagePack.getImage("Popeslug2.png"), ImagePack.getImage("Popeslug3.png"),
					ImagePack.getImage("Popeslug4.png"), ImagePack.getImage("Popeslug5.png"), ImagePack.getImage("Popeslug6.png"),
					ImagePack.getImage("Popeslug7.png"), ImagePack.getImage("Popeslug8.png")}, {
