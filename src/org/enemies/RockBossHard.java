...
public class RockBossHard extends Enemy{
	int deathDelay=-1;
	int hitDelay=0;
	int counter;
	int proAdd=0;
	public static final BufferedImage[]ani=new BufferedImage[]{
		ImagePack.getImage("earthlevel/rockboss.png"),
		ImagePack.getImage("earthlevel/rockboss4.png"),
		ImagePack.getImage("earthlevel/rockboss.png"),
		ImagePack.getImage("earthlevel/rockboss2.png"),
		ImagePack.getImage("earthlevel/rockboss3.png"),
	};
	public RockBossHard(int X,int Y){
		x=X;y=Y;w=84;h=85;
