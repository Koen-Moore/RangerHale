...
public class Lava extends Enemy{
	...
	private static final BufferedImage[]ani=new BufferedImage[]{
		ImagePack.getImage("lava/lava1.png"),
		ImagePack.getImage("lava/lava2.png"),
		ImagePack.getImage("lava/lava3.png"),
		ImagePack.getImage("lava/lava4.png"),
		ImagePack.getImage("lava/lavamid1.png"),
		ImagePack.getImage("lava/lavamid2.png"),
		ImagePack.getImage("lava/lavamid3.png"),
