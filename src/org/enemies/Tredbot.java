...
public class Tredbot extends Enemy {
	private static volatile BufferedImage[][] ani = {
			{ImagePack.getImage("Robot/tredBot3.png"), ImagePack.getImage("Robot/tredBot2.png"), ImagePack.getImage("Robot/tredBot1.png"),},
			{ImagePack.getImage("Robot/tredBot3r.png"), ImagePack.getImage("Robot/tredBot2r.png"),
