...
public class Slurg extends Enemy implements Runnable {
	private static volatile BufferedImage[][] ani = new BufferedImage[][]{
			{ImagePack.getImage("slurg/slurg1.png"), ImagePack.getImage("slurg/slurg2.png"), ImagePack.getImage("slurg/slurgANGRY1.png"),
					ImagePack.getImage("slurg/slurgANGRY2.png")},
			{ImagePack.getImage("slurg/slurgright1.png"), ImagePack.getImage("slurg/slurgright2.png"),
					ImagePack.getImage("slurg/slurgANGRYright1.png"), ImagePack.getImage("slurg/slurgANGRYright2.png")}};
