...
public class Fireman extends Enemy
{
	  private static volatile BufferedImage[][] ani = { 
	    { 
	    ImagePack.getImage("fireman1.png"), 
	    ImagePack.getImage("fireman2.png"), 
	    ImagePack.getImage("fireman3.png"), 
	    ImagePack.getImage("fireman4.png"), 
	    ImagePack.getImage("fireman5.png") }, 
	    { 
	    ImagePack.getImage("fireman1R.png"), 
	    ImagePack.getImage("fireman2R.png"), 
	    ImagePack.getImage("fireman3R.png"), 
	    ImagePack.getImage("fireman4R.png"), 
	    ImagePack.getImage("fireman5R.png") } };

	  //private boolean left = true;
	  private int counter = (int)(300.0D * Math.random());

	  public Fireman(int X, int Y) { this.element = Element.FIRE;
	    this.w = 17; this.h = 23;
	    this.x = X; this.y = Y;
	    this.image = ani[0][0];
