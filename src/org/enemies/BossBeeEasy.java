...
public class BossBeeEasy extends Enemy {
	private static final BufferedImage[] ani = new BufferedImage[]{ImagePack.getImage("airlevel/kingBee.png"),
			ImagePack.getImage("airlevel/kingBee2.png"), ImagePack.getImage("airlevel/angryKingBee.png"),
			ImagePack.getImage("airlevel/angryKingBee2.png"), ImagePack.getImage("airlevel/sadKingBee.png"),
			ImagePack.getImage("airlevel/kingBeeR.png"), ImagePack.getImage("airlevel/kingBee2R.png"),
			ImagePack.getImage("airlevel/angryKingBeeR.png"), ImagePack.getImage("airlevel/angryKingBee2R.png"),
			ImagePack.getImage("airlevel/sadKingBeeR.png"),};
	boolean angry;
	// private double vx=0,vy=2;
	int deathDelay = -1;
	private int counter = (int) (300 * Math.random());
	public BossBeeEasy(float X, float Y) {
		element = Element.AIR;
		// images=ani;
		image = ani[0];
