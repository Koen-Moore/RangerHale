...
public class FireBossRoomEasy extends Room {
	...
	public void load() {
		...
		walls = new ThreadList<Wall>(Arrays.asList(new Wall[]{new Wall(0, 0, 0, HEIGHT), new Wall(0, 0, WIDTH, 0),
				new Wall(0, HEIGHT, WIDTH, HEIGHT), new Wall(WIDTH, 0, 0, HEIGHT), new FirePlatform(30, 360, 2),
				new FirePlatform(230, 360, 1), new FirePlatform(430, 360, 1), new FirePlatform(630, 360, 2),}));
	...
	public static BufferedImage[] ani = new BufferedImage[]{ImagePack.getImage("menu stuff/starBack.png"),
			ImagePack.getImage("backgrounds/volcanicplanet.png")};
