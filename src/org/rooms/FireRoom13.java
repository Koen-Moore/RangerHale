...
public class FireRoom13 extends Room {
	...
	public void load() {
		...
		walls = new ThreadList<Wall>(Arrays.asList(new Wall[]{new Wall(0, 0, 0, HEIGHT), new Wall(0, 0, WIDTH, 0),
				...
				new FirePlatform(0, 420, 2), new FirePlatform(120, 420, 2), new FirePlatform(300, 250, 1), new FirePlatform(420, 330, 2),
				new FirePlatform(410, 120, 2), new FirePlatform(330, 540, 1), new FirePlatform(530, 175, 2),}));
		background = new Background();
		background.fillBack(new Color(68, 37, 18));
		background.tessellateOnBottom(cave1);
		exit = new FireExit(560, 95);
		walls.add(new FireDoor(0, 340));
		...
		// }
		/*
		 * for(int x=0;x<30;x+=10){ enemies.add(new Fireman(270+x,320)); }
