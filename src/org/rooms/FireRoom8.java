...
public class FireRoom8 extends Room {
	...
	public void load(){
		...
		walls=new ThreadList<Wall>(Arrays.asList(new Wall[]{
	    	...
	    	new FirePlatform(0,140,2),
	    	new FirePlatform(100,220,2),
	    	new FirePlatform(200,350,2),
	    	new FirePlatform(300,250,2),
	    	new FirePlatform(460,250,3),
	    	new FirePlatform(510,460,1),
		}));
