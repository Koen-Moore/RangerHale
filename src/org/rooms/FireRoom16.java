...
public class FireRoom16 extends Room {
	...
	public void load() {
		...
		walls = new ThreadList<Wall>(Arrays.asList(new Wall[]{new Wall(0, 0, 0, HEIGHT), new Wall(0, 0, WIDTH, 0),
				...
				new FirePlatform(0, 220, 2), new FirePlatform(120, 420, 2),
				// new FirePlatform(300,250,1),
				new FirePlatform(220, 200, 2), new FirePlatform(480, 360, 2), new FirePlatform(370, 220, 2), new FirePlatform(330, 475, 1),
