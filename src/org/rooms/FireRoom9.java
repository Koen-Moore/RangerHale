...
public class FireRoom9 extends Room {
	...
	public void load() {
		...
		walls = new ThreadList<Wall>(Arrays.asList(new Wall[]{new Wall(0, 0, 0, HEIGHT), new Wall(0, 0, WIDTH, 0),
				...
				new FirePlatform(0, 80, 2), new FirePlatform(100, 480, 2), new FirePlatform(260, 420, 2), new FirePlatform(400, 300, 1),
