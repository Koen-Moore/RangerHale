...
public class FireRoom5 extends Room {
	...
	public void load(){
		...
		walls=new ThreadList<Wall>(Arrays.asList(new Wall[]{
	    	...
	    	new FirePlatform(0,175,2),
	    	new FirePlatform(90,300,2),
	    	new FirePlatform(200,425,1),
	    	new FirePlatform(325,300,2),
	    	new FirePlatform(430,175,3),
	    	//new FirePlatform(600,200,1),
		}));
		background=new Background();
		background.fillBack(new Color(68,37,18));
		background.tessellateOnBottom(cave1);
		exit=new FireExit(460,95);
		walls.add(new FireDoor(0,95));
		...
		for(int x=0;x<30;x+=10){
			enemies.add(new Fireman(200+x,400));
		}
		for(int x=0;x<10;x+=10){
			enemies.add(new FireSkull(200+x,405));
		}
