...
public class FireRoom6 extends Room {
	...
	public void load() {
		...
		walls = new ThreadList<Wall>(Arrays.asList(new Wall[]{new Wall(0, 0, 0, HEIGHT), new Wall(0, 0, WIDTH, 0),
				...
				new FirePlatform(0, 200, 1), new FirePlatform(100, 200, 2), new FirePlatform(400, 300, 1), new FirePlatform(250, 400, 2),
				new FirePlatform(550, 400, 3),

				new FirePlatform(620, 290, 0), new FirePlatform(660, 250, 0), new FirePlatform(700, 200, 1),}));
