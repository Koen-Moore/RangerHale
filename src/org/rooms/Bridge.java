...
public class Bridge extends Room{
	static final BufferedImage hull=ImagePack.getImage("backgrounds/shipHull.png"),
		hull2=ImagePack.getImage("backgrounds/shipHullWindow2.png"),
		hull3=ImagePack.getImage("backgrounds/shipHullDark.png"),
	...
	public void load(){
	    ...
	    /*backdrop.add(new HudTitle("ELEVATORS ARE DOWN, YOU MUST",260,35,white));
	    ...
	    backdrop.add(new HudTitle("JUMPING AT A WALL AND THEN USE",100,330,white));
