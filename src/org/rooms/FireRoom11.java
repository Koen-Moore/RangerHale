...
public class FireRoom11 extends Room {
	...
	public void load(){
		...
		walls=new ThreadList<Wall>(Arrays.asList(new Wall[]{
	    	...
	    	new FirePlatform(0,480,2),
	    	new FirePlatform(130,400,2),
	    	new FirePlatform(270,260,2),
	    	//new FirePlatform(480,340,1),
