...
public class Room3 extends Room {
	...
	public static final BufferedImage mountain = ImagePack.getImage("backgrounds/MountainBACK.png"), cliff = ImagePack
			.getImage("cliff.png"), door = ImagePack.getImage("earthlevel/caveDoor.png"), door2 = ImagePack
			.getImage("earthlevel/caveDoor2.png");
	public void load() {
		HEIGHT = 800;
		WIDTH = 800;
		spriteX = 0;
