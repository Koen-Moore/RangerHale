...
public class AirRoom2 extends Room {
	...
	public void load() {
		...
		visibleWIDTH = 500;
		startLeft = false;
		walls = new ThreadList<Wall>(Arrays.asList(new Wall[]{new Wall(0, 0, 0, HEIGHT),
				...
				new CloudPlatform(400, 300, 4), new CloudPlatform(270, 450, 6), new CloudPlatform(80, 450, 4),
				new CloudPlatform(0, 600, 3), new CloudPlatform(180, 600, 4), new CloudPlatform(400, 600, 4),
				// new CloudPlatform(270,750,6),
				// new CloudPlatform(80,750,4),
				new CloudPlatform(270, 150, 6), new CloudPlatform(80, 150, 4),
