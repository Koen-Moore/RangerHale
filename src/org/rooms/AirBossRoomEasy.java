...
public class AirBossRoomEasy extends Room {
	...
	public void load() {
		...
		ep=new EscapePod[]{
				new EscapePod(325,750,1),
				new EscapePod(375,750,2),
				new EscapePod(425,750,3),
		...
		public static BufferedImage[]ani=new BufferedImage[]{
			ImagePack.getImage("menu stuff/starBack.png"),ImagePack.getImage("backgrounds/airplanet.png")
		};
