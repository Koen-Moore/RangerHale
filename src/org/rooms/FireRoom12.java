...
public class FireRoom12 extends Room {
	...
	public void load() {
		...
		walls = new ThreadList<Wall>(Arrays.asList(new Wall[]{new Wall(0, 0, 0, HEIGHT), new Wall(0, 0, WIDTH, 0),
				...
				new FirePlatform(0, 320, 2), new FirePlatform(90, 380, 2), new FirePlatform(250, 310, 2), new FirePlatform(400, 220, 1),
				new FirePlatform(530, 180, 1), new FirePlatform(230, 440, 3),}));
