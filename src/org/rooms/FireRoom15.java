...
public class FireRoom15 extends Room {
	...
	public void load(){
		...
		walls=new ThreadList<Wall>(Arrays.asList(new Wall[]{
	    	...
	    	new FirePlatform(40,420,2),
	    	new FirePlatform(90,120,2),
	    	new FirePlatform(230,240,1),
	    	new FirePlatform(370,340,2),
	    	new FirePlatform(730,175,2),
	    	new FirePlatform(410,120,2),
	    	new FirePlatform(570,120,1),
	    	new FirePlatform(540,420,2),
		}));
