...
public class Room1 extends Room {
	...
	public void load() {
		...
		walls = new ThreadList<Wall>(Arrays.asList(new Wall[]{new Wall(0, 0, 0, HEIGHT), new Wall(0, 0, WIDTH, 0),
				new Wall(0, HEIGHT, WIDTH, 500), new Wall(WIDTH, 0, 0, HEIGHT), new Wall(0, 325, 3, 53, black),
				new Wall(3, 325, 10, 3, black), new Wall(0, 375, 50, 3, black), new Wall(50, 450, 30, 3, red),
				new Wall(100, 300, 30, 3, new Color(30, 50, 10)), new Wall(xof + 50, yof + 350, 30, 3, red),
				new Wall(xof + 80, yof + 320, 30, 3, darkGray), new Wall(xof + 110, yof + 290, 30, 3, blue),
				new Wall(xof + 140, yof + 260, 30, 3, gray), new Wall(xof + 170, yof + 230, 30, 3, new Color(0, 50, 0)),
				new Wall(xof + 110, yof + 170, 30, 3, red), new Wall(xof + 50, yof + 155, 60, 3, blue),
				kraid = new DamageableWall(xof + 290, yof + 120, 40, 50, null), new DamagingWall(xof + 255, yof + 195, 40, 75, null),
				new DamagingWall(xof + 220, yof + 195, 40, 30, null), new DamagingWall(xof + 273, yof + 153, 40, 60, null),
				new DamagingWall(xof + 220, yof + 270, 120, 130, null), new DamagingWall(xof + 330, yof + 350, 70, 50, null)}));
		...
		/*
		 * enemies.add(new JoeMamma(300,470,-3,-3)); enemies.add(new
		 * JoeMamma(30,470,-3,3)); enemies.add(new JoeMamma(300,40,3,3));
		 * enemies.add(new JoeMamma(300,400,3,-3)); enemies.add(new
		 * JoeMamma(350,400,-3,3)); enemies.add(new JoeMamma(500,10,3,-3));
		 */
	...
	public boolean isDead() {
		...
		if (countdown == 0 || Player.player.life <= 0)
			return true;
		return false;
	}
}