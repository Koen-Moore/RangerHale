...
public class PauseOptions extends HUD {
	...
	public static final BufferedImage[] ani = new BufferedImage[]{ImagePack.getImage("menu stuff/back.png"),
			ImagePack.getImage("menu stuff/backs.png"), ImagePack.getImage("menu stuff/anti.png"),
			ImagePack.getImage("menu stuff/antis.png"),};
	public HUD backRef;
	public PauseOptions(int w, int h, HUD hud) {
		super(w, h);
		backRef = hud;
