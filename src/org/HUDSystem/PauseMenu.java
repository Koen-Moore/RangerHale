...
public class PauseMenu extends HUD{
	...
	public static final BufferedImage[]ani=new BufferedImage[]{
		ImagePack.getImage("menu stuff/resume.png"),ImagePack.getImage("menu stuff/resumes.png"),
		...
		ImagePack.getImage("menu stuff/main.png"),ImagePack.getImage("menu stuff/mains.png"),
