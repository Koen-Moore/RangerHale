...
public class NewGameMenu extends HUD{
	...
	public static final BufferedImage[]ani=new BufferedImage[]{
		...
		ImagePack.getImage("menu stuff/make.png"),ImagePack.getImage("menu stuff/makes.png"),
		ImagePack.getImage("menu stuff/textUsername.png"),ImagePack.getImage("menu stuff/textPassword.png"),
	};
	public HUD backRef;
