...
public class MainMenu extends HUD {
	...
	public static final BufferedImage[] ani = new BufferedImage[]{ImagePack.getImage("menu stuff/new.png"),
			ImagePack.getImage("menu stuff/news.png"), ImagePack.getImage("menu stuff/option.png"),
			ImagePack.getImage("menu stuff/options.png"), ImagePack.getImage("menu stuff/load.png"),
			ImagePack.getImage("menu stuff/loads.png"), ImagePack.getImage("menu stuff/exit.png"),
