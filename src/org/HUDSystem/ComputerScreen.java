...
public class ComputerScreen extends HUD{
	public static final BufferedImage[]ani=new BufferedImage[]{
		ImagePack.getImage("menu stuff/computerMessage.png"),
		ImagePack.getImage("menu stuff/computerError.png"),
		ImagePack.getImage("menu stuff/computerError2.png"),
		ImagePack.getImage("menu stuff/computerError3.png"),
		ImagePack.getImage("menu stuff/planetSelect.png"),
		ImagePack.getImage("menu stuff/computerButtons1.png"),
		ImagePack.getImage("menu stuff/computerButtons2.png"),
		ImagePack.getImage("menu stuff/computerButtons3.png"),
		ImagePack.getImage("menu stuff/computerButtons4.png"),
	...
	public void draw(Graphics g){
		if(computerstate<2){
			if(computerstate==0)image=ani[0];
			if(computerstate==1){
				counter++;
				image=ani[1+counter/20%2];
				if(counter>200)image=ani[3];
				if(counter<60){
		...
		if(computerstate==3)Bridge.dead=true;
			...
			if(KeyList.keyboard[10]||KeyList.keyboard[32]){
				...
				case 4:
					if(computerstate==2){
						...
						switch(curButton){
						case 1:RoomRunner.loadFireLevel(true);break;
						case 2:RoomRunner.loadWaterLevel(true);break;
						case 3:RoomRunner.loadRockLevel(true);break;
						case 4:RoomRunner.loadAirLevel(true);break;
						}
						Room.endFast=true;
						break;
					}
