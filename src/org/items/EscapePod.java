...
public class EscapePod extends LivingObject implements Runnable {
	...
	public int type;
	public static final BufferedImage[] ani = new BufferedImage[]{ImagePack.getImage("escape pod.png"), ImagePack.getImage("firePod.png"),
			ImagePack.getImage("waterPod.png"), ImagePack.getImage("rockPod.png"), ImagePack.getImage("windPod.png"),
